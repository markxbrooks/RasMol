...
# changes by Clarice Chigbo, Ricky Chachra, and Mamoru Yamanishi. Work on #
# RasMol 2.7.3 supported in part by grants DBI-0203064, DBI-0315281 and   #
# EF-0312612 from the U.S. National Science Foundation and grant          #
...
#                                                                         #
#   This version is based in directly on RasMol version 2.7.5.1, on       #
#   RasMol version 2.7.5, on RasMol version 2.7.4, on RasMol version      #
#   2.7.3.1, on RasMol version 2.7.3, on RasMol version 2.7.2.1.1,        #
...
#  Rev, 14 May 2011 for RasMol 2.7.5.2
#
...
VERSION=${RASMOL_VERSION-"RasMol_2_7_5_2"};
